...
class VQA_extract:
    ...
    def run(self):
        ...
        self.pic_extractor.run("../vqa/layout_concatenated_images", "../vqa/vqa_extract", subject="chemistry")
...
if __name__ == "__main__":
    vqa_extract = VQA_extract("./dataflow/example/KBCleaningPipeline/chemistry_test.pdf")
    vqa_extract.run()
    ...
    with open("../vqa/vqa_extract/qapair_extract_cut.jsonl", "w") as f:
        f.writelines(lines)
    # 去重
    vqa_deduplicate = VQA_deduplicate("../vqa_physics/4o/vqa_extract/qapair_extract_cut.jsonl")
    vqa_deduplicate.run()