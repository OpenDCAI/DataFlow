...
_import_structure = {
    ...
    # KBC
    "corpus_text_splitter": (cur_path + "KnowledgeCleaning/corpus_text_splitter.py", "corpus_text_splitter"),
    "knowledge_extractor": (cur_path + "KnowledgeCleaning/knowledge_extractor.py", "knowledge_extractor"),
    "knowledge_cleaner": (cur_path + "KnowledgeCleaning/knowledge_cleaner.py", "knowledge_cleaner"),
    "multihop_qa_generator": (cur_path + "KnowledgeCleaning/multihop_qa_generator.py", "multihop_qa_generator"),
