...
class RemoveEmoticonsRefiner(OperatorABC):
    def __init__(self):
    ...
    def run(self, storage: DataFlowStorage, input_key: str):
        ...
        for item in tqdm(dataframe[self.input_key], desc=f"Implementing {self.__class__.__name__}"):
            ...
            if original_text != no_emoticon_text:
                item = no_emoticon_text
                modified = True  
                self.logger.debug(f"Modified text for key '{self.input_key}': Original: {original_text[:30]}... -> Refined: {no_emoticon_text[:30]}...")
