...
class FilterInitScorerPrompt(PromptABC):
    """
    Initial content quality scoring prompt (1–5 scale)
    """
    def __init__(self):
        pass
...
@PROMPT_REGISTRY.register()
class FilterRefinerPrompt(PromptABC):
    """
    Prompt for refining medium-quality JSON content
    """
    def __init__(self):
        pass
...
@PROMPT_REGISTRY.register()
class FilterRewriterPrompt(PromptABC):
    """
    Prompt for expanding high-quality JSON content
    """
    def __init__(self):
        pass
...
@PROMPT_REGISTRY.register()
class FilterFinalScorerPrompt(PromptABC):
    """
    Final content quality assessment (1–5 scale)
    """
    def __init__(self):
        pass
